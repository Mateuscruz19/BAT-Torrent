...
| プラットフォーム | 形式 | 備考 |
|---|---|---|
| Windows | [インストーラー (`.exe`)](https://github.com/Mateuscruz19/BAT-Torrent/releases/latest) · [ポータブル版 (`.zip`)](https://github.com/Mateuscruz19/BAT-Torrent/releases/latest) | Windows 10+ (x86_64) |
| macOS | [ディスクイメージ (`.dmg`)](https://github.com/Mateuscruz19/BAT-Torrent/releases/latest) | macOS 12+ (Apple Silicon) |
...
### インターフェース
- 3 つのテーマ — Dark、Light（暖かいクリーム色の「Comfortable」パレット）、Midnight — グローバル QPalette オーバーライドにより、プレーンなウィジェットもアクティブテーマに追従。
...
- **7 つの UI 言語**（自動検出対応）：English、Português (BR)、Español、Deutsch、Русский、日本語、中文 — 622 の翻訳文字列（不足キーは英語にフォールバック）。
...
1. お使いのプラットフォーム用のビルドを[リリースページ](https://github.com/Mateuscruz19/BAT-Torrent/releases/latest)からダウンロードしてください。
