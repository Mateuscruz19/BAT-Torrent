...
| プラットフォーム | | |
|---|---|---|
| **Windows** | [Microsoft Store](https://apps.microsoft.com/detail/9n4l3tq24rc6) · [インストーラー](https://github.com/Mateuscruz19/BATorrent/releases/latest) · [ポータブル版](https://github.com/Mateuscruz19/BATorrent/releases/latest) | Windows 10+ |
