...
|---|---|---|
| Windows | [Установщик (`.exe`)](https://github.com/Mateuscruz19/BAT-Torrent/releases/latest) · [Портативная версия (`.zip`)](https://github.com/Mateuscruz19/BAT-Torrent/releases/latest) | Windows 10+ (x86_64) |
| macOS | [Образ диска (`.dmg`)](https://github.com/Mateuscruz19/BAT-Torrent/releases/latest) | macOS 12+ (Apple Silicon) |
...
- **Семь языков интерфейса** с автоопределением: English, Português (BR), Español, Deutsch, Русский, 日本語, 中文 — 622 переведённые строки с откатом на английский для отсутствующих ключей.
...
1. Скачайте сборку для вашей платформы со [страницы релизов](https://github.com/Mateuscruz19/BAT-Torrent/releases/latest).
