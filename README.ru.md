...
| Платформа | | |
|---|---|---|
| **Windows** | [Microsoft Store](https://apps.microsoft.com/detail/9n4l3tq24rc6) · [Установщик](https://github.com/Mateuscruz19/BATorrent/releases/latest) · [Портативная версия](https://github.com/Mateuscruz19/BATorrent/releases/latest) | Windows 10+ |
